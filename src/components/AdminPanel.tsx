...
export default function AdminPanel() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (lower === 'nyawirainah2026' || lower === 'nyawirainah' || lower === 'nyawira' || lower === 'mainah' || lower === '2026') {
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute('download', `nyawira_and_mainah_wedding_rsvps_${new Date().toISOString().slice(0,10)}.csv`);
    ...
    <>
      ...
      <div className="py-10 bg-stone-900 flex justify-center border-t border-stone-950 text-stone-100 font-sans text-xs select-none">
        <div className="flex flex-col items-center gap-2">
          <p className="text-stone-300">© 2026 Nyawira &amp; Mainah. All rights reserved.</p>
          <button
          ...
          >
            ...
            <span className="text-[9px] bg-sage-950/80 text-sage-300 border border-sage-800/40 px-1.5 py-0.5 rounded-full font-mono text-[8px] font-bold tracking-wider uppercase">Secured</span>
          </button>
        </div>
      </div>
            ...
            <div className="bg-white border border-stone-200 rounded-3xl w-full max-w-4xl shadow-2xl overflow-hidden relative flex flex-col my-8 max-h-[90vh]">
              ...
              <div className="border-b border-stone-100 p-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-stone-500 font-sans">Nyawira &amp; Mainah Wedding RSVP Dashboard</p>
                  </div>
                </div>
                <button
              ...
              {!isAuthenticated ? (
                <div className="p-12 flex flex-col items-center justify-center text-center max-w-sm mx-auto space-y-6">
                  <div className="w-16 h-16 rounded-full bg-sage-50 flex items-center justify-center text-sage-800 animate-pulse">
                    <Key className="w-8 h-8" />
                  </div>
                  <div className="space-y-2">
                    <h4 className="font-serif text-lg text-stone-900 font-medium">Passcode Required</h4>
                    <p className="text-xs text-stone-500">Exclusively for Nyawira &amp; Mainah to access the guest RSVP database.</p>
                  </div>
