      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto bg-white border border-stone-200/80 p-6 rounded-2xl shadow-sm mb-12 relative z-10">
          ...
          <div className="flex flex-col items-center text-center p-3">
            <div className="w-10 h-10 rounded-full bg-sage-100 text-sage-800 flex items-center justify-center mb-2">
          ...
          <div className="flex flex-col items-center text-center p-3 border-y sm:border-y-0 sm:border-x border-stone-150">
            ...
            <p className="text-sm text-stone-800 font-serif font-medium">10:00 AM Prompt</p>
            <p className="text-xs text-sage-700 font-sans mt-1 font-medium">Church Service</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center p-3">
            ...
            <p className="text-sm text-stone-800 font-serif font-medium leading-tight">ACK EMMANUEL CHURCH</p>
            <p className="text-xs text-sage-700 font-sans mt-1 font-medium">Kikuyu, Kenya</p>
          </div>
        </div>
          ...
          <div className="inline-flex bg-stone-100 border border-stone-250 p-1 rounded-full shadow-inner">
            <button
              ...
              className={`px-6 py-2.5 text-xs md:text-sm font-sans font-semibold uppercase tracking-wider rounded-full transition-all flex items-center gap-2 cursor-pointer ${
                activeVenue === 'ceremony' ? 'bg-sage-700 text-white shadow-xs' : 'text-stone-600 hover:text-stone-900'
              }`}
            >
              <Compass className="w-4 h-4" />
              <span>1. Ceremony (Church 10 AM)</span>
            </button>
            <button
              onClick={() => setActiveVenue('reception')}
              className={`px-6 py-2.5 text-xs md:text-sm font-sans font-semibold uppercase tracking-wider rounded-full transition-all flex items-center gap-2 cursor-pointer ${
                activeVenue === 'reception' ? 'bg-sage-700 text-white shadow-xs' : 'text-stone-600 hover:text-stone-900'
              }`}
            >
              <Navigation className="w-4 h-4" />
              <span>2. Reception (Leilani Gardens 1 PM)</span>
            </button>
          </div>
        </div>
          ...
          <div className="lg:col-span-4 flex flex-col justify-between bg-white border border-stone-200/60 rounded-2xl shadow-md relative overflow-hidden">
            ...
            <div className="p-8 flex flex-col justify-between flex-1">
              <div className="space-y-6 z-10">
                <span className="text-[10px] tracking-widest uppercase font-sans font-extrabold text-sage-800 px-2.5 py-1 bg-sage-100 rounded-full border border-sage-200 inline-block">
                  {activeVenue === 'ceremony' ? 'Part A: Church Service' : 'Part B: Reception & Cake Feast'}
                </span>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sage-700 text-xs tracking-wider uppercase font-sans font-medium">
                    {activeVenue === 'ceremony' ? 'Holy Matrimony' : 'Reception Celebration'}
                  </p>
                </div>

                <div className="space-y-4 pt-4 border-t border-stone-100">
                  <div className="flex items-start gap-3">
                    <MapPin className="w-5 h-5 text-sage-700 mt-0.5 shrink-0" />
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <Navigation className="w-5 h-5 text-sage-700 mt-0.5 shrink-0" />
                    <div>
                      <p className="text-xs text-stone-400 uppercase tracking-widest font-sans font-bold">Timeline</p>
                      <p className="text-sm text-stone-600 mt-0.5">
                        {activeVenue === 'ceremony' ? '10:00 AM Prompt' : 'Expected Reception Time: 1:00 PM'}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-6 border-t border-stone-100 z-10">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-sage-50 border border-sage-200 hover:bg-sage-700 hover:text-white font-sans font-bold uppercase tracking-wider text-xs text-sage-900 rounded-xl transition-all shadow-xs group"
                >
