    ...
    <section className="relative py-24 bg-[#FAF7F2] text-stone-800 border-t border-stone-200/60" id="program-section">
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-16">
          <span className="text-sage-700 text-xs font-semibold tracking-widest uppercase font-sans">The Wedding Schedule</span>
          ...
          <p className="text-stone-600 text-sm md:text-base mt-4 max-w-xl mx-auto italic font-serif">
            ...
            <span className="text-sage-700 uppercase font-sans text-xs tracking-wider font-semibold not-italic block mt-1">— Ecclesiastes 4:9</span>
          </p>
        </div>
